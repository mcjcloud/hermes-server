 ...
 *     is expected to perform short execMution task.  It is due
...
void bleCentralDiscoverHandler(BLEDevice peripheral) {
  if(peripheral.rssi()>-50){// discovered a peripheral
  ...
  if (peripheral.hasLocalName()&&peripheral.localName()=="AA-TAG") {
    //Serial.print("Local Name: ");
    //Serial.println(peripheral.localName());
  

  // print the advertised service UUID's, if present
    if (peripheral.hasAdvertisedServiceUuid()&&peripheral.localName()=="AA-TAG") {
